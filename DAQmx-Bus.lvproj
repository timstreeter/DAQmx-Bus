...
<Project Type="Project" LVVersion="21008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Examples" Type="Folder">
			...
			<Item Name="1 - DAQmx Bus Digital Input.vi" Type="VI" URL="../../../Program Files (x86)/National Instruments/LabVIEW 2021/examples/TSA/DAQmx-Bus/Examples/1 - DAQmx Bus Digital Input.vi"/>
			<Item Name="2 - DAQmx Bus Analog Input.vi" Type="VI" URL="../Source/Examples/2 - DAQmx Bus Analog Input.vi"/>
			<Item Name="3 - DAQmx Bus Analog Output.vi" Type="VI" URL="../Source/Examples/3 - DAQmx Bus Analog Output.vi"/>
			<Item Name="4 - DAQmx Bus Digital Input and Output.vi" Type="VI" URL="../Source/Examples/4 - DAQmx Bus Digital Input and Output.vi"/>
			<Item Name="5 - DAQmx Bus Analog Input and Output.vi" Type="VI" URL="../Source/Examples/5 - DAQmx Bus Analog Input and Output.vi"/>
			<Item Name="6 - DAQmx Bus Waveform Analog Input.vi" Type="VI" URL="../Source/Examples/6 - DAQmx Bus Waveform Analog Input.vi"/>
			<Item Name="7 - DAQmx Bus Waveform Output and Input.vi" Type="VI" URL="../Source/Examples/7 - DAQmx Bus Waveform Output and Input.vi"/>
		</Item>
